...
import { Bars3Icon, BugAntIcon, RectangleGroupIcon, RocketLaunchIcon } from "@heroicons/react/24/outline";
    ...
    <div className="bg-sky-900 sticky lg:static top-0 navbar bg-base-100 min-h-0 flex-shrink-0 justify-between z-20 shadow-md shadow-secondary px-4 sm:px-8">
      ...
      <div className="navbar-end flex-grow justify-end">
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6 shrink-0">
          <div className="flex relative w-24 h-16">
            <Image alt="Ninja Strike" className="cursor-pointer object-contain" fill src="/logo.svg" />
          </div>
        </Link>
        <ul className="hidden lg:flex lg:flex-nowrap menu menu-horizontal px-1 gap-2">
          <HeaderMenuLinks />
