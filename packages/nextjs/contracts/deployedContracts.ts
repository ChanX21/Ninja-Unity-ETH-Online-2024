  ...
  31337: {
    ...
    InheritanceContract: {
      ...
      abi: [
        ...
        {
          inputs: [],
          name: "getTimeLeftBeforeHeirOwnership",
          outputs: [
            {
              internalType: "uint256",
              name: "",
